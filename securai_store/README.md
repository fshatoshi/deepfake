...
| **Traoré** | Attaque FGSM (client & serveur), FaceNet sur crop YOLO, entraînement defender, mode statique, recherche cloud GPU, patch lunettes live (T1), tests pytest (T3), toggle_gpu.py (T4), anti-spoofing LBP (T5) |
| **François** | — |
| **Yassin** | — |
